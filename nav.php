  ...
  <br />
        ...
        <div class="blog container blog-list core-coins">
            ...
            <article class="post small-post col-md-4 col-sm-6 col-xs-12">
                <div class="post-inner">
                    <figure class="post-thumb">
                        <a href="#" onmouseover="tooltip.pop(this, '#coin-info-6')">
                            <img class="img-responsive" src="assets/images/coin-logos/logo-bit-192.png" alt="BITS">
                        </a>
                    </figure><!--//post-thumb-->
                    <div style="display: none;">
                        <div id="coin-info-6">
                          <!-- Tooltip Content -->
                          Website: <a href="http://bitstarcoin.com/">Bitstarcoin.com</a><br>
                          Forum: <a href="https://bitcointalk.org/index.php?topic=748045">Bitcointalk.org</a>
                        </div>
                    </div>
                    <div class="content">
                        <!-- <div class="post-entry">
                        ...
                        <div class="meta">
                            <div class="meta-list list-inline">
                              <h3 class="post-title text-left">
                                  <a href="#" onmouseover="tooltip.pop(this, '#coinbalance-info-6')"><span class="amount" id="totalbits"></span></a> BITS</h3>
                              <p class="text-left"><span id="bitsbtcbalance"></span> BTC</p>
                          </div><!--//meta-list-->
                          <div style="display: none;">
            ...
            <article class="post small-post col-md-4 col-sm-6 col-xs-12">
                <div class="post-inner">
                    <figure class="post-thumb">
                        <a href="#" onmouseover="tooltip.pop(this, '#coin-info-7')">
                            <img class="img-responsive" src="assets/images/coin-logos/logo-fibre-192.png" alt="FIBRE">
                        </a>
                    </figure><!--//post-thumb-->
                    <div style="display: none;">
                        <div id="coin-info-7">
                          <!-- Tooltip Content -->
                          Forum: <a href="https://bitcointalk.org/index.php?topic=737771.0">Bitcointalk.org</a>
                        </div>
                    </div>
                    <div class="content">
                        <!-- <div class="post-entry">
