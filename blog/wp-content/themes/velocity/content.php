	...
	<header class="entry-header">
		...
		<div class="meta">
			<ul class="meta-list list-inline">                                       
				<li class="post-time"><?php the_date(); ?></li>
				<li class="post-author"> by <a href="#"><?php echo get_the_author_meta( 'user_nicename' ); ?> </a></li>
				<li class="post-comments-link">
					<a href="<?php comments_link(); ?>"><i class="fa fa-comments"></i><?php comments_number( '0', '1', '%' ); // comments_number( 'no responses', 'one response', '% responses' ); ?></a>
				</li>
			</ul><!--//meta-list-->                           	
		</div>
...
<div class="share-container"><!--//Social media buttons: https://github.com/kni-labs/rrssb (More examples) -->
	<!-- 
	<span class="label">share this:</span>
	-->
	<!-- Buttons start here. Copy this ul to your document. -->
	<ul class="rrssb-buttons clearfix rrssb-1">
		<li class="rrssb-facebook" data-initwidth="14.285714285714286" style="width: calc(20% - 16.8px);" data-size="64">
		...
		<li class="rrssb-twitter" data-initwidth="14.285714285714286" style="width: calc(20% - 16.8px);" data-size="50">
			<!-- Replace href with your Meta and URL information  -->
			<a href="http://twitter.com/home?status=<?php the_title(); ?>%20<?php the_permalink(); ?>" class="popup">
				<span class="rrssb-icon">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
		...
		<li class="rrssb-reddit" data-initwidth="14.285714285714286" style="width: calc(20% - 16.8px);" data-size="42">
		...
		<li class="rrssb-googleplus" data-initwidth="14.285714285714286" style="width: calc(20% - 16.8px);" data-size="56">
			<!-- Replace href with your meta and URL information.  -->
			<a href="https://plus.google.com/share?url=<?php the_title(); ?>%20<?php the_permalink(); ?>" class="popup">
				<span class="rrssb-icon">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
						<g>
							<g>
		...
		<li class="rrssb-linkedin" data-initwidth="14.285714285714286" style="width: calc(20% - 16.8px);" data-size="53">
			<!-- Replace href with your meta and URL information -->
		...
		<li class="rrssb-pocket small" data-initwidth="14.285714285714286" style="width: 42px;" data-size="46">
			<a href="https://getpocket.com/save?url=<?php the_permalink(); ?>">
				<span class="rrssb-icon">
		...
		<!--
		<li class="rrssb-github small" data-initwidth="14.285714285714286" style="width: 42px;" data-size="44">
